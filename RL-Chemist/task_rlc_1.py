...
def parse_args():
    ...
    # parser.add_argument('--env_name', default='UR10eReach4C-v1', type=str)
    ...
    # replay buffer
    parser.add_argument('--replay_buffer_capacity', default=150_000, type=int)
    
    # train
    parser.add_argument('--init_steps', default=5_000, type=int)
    parser.add_argument('--env_steps', default=150_000, type=int)
...
def main(seed=-1, env_name=None):
    ...
    env = UR10_4C_ENV(args.env_name, args.image_history, args.image_width, args.image_height)
...
if __name__ == '__main__':
    ...
    # for i in range(3, 6):
    #     main(i, "UR10eMask4C-v1")
    #     time.sleep(5)
        
    for i in range(5):
        main(i, "UR10eReach4C-v1")
        time.sleep(5)
