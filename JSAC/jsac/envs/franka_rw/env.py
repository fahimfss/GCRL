...
from jsac.envs.franka_rw.franka_dense_env import FrankaPanda_Visual_Reacher
import time
...
class franka_env(gym.Wrapper):
    def __init__(self,
        ...
        self.env = FrankaPanda_Visual_Reacher(dt=dt, classifier=classifier, seed=seed)
    ...
    def reset(self, create_vid=False, **kwargs):
        ...
        new_img, prop = self.env.reset(**kwargs) 
