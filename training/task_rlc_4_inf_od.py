...
def parse_args():
    ...
    parser.add_argument('--env_name', default='UR10eEnv-v3', type=str)   # FrankaEnv-v1
...
def main(seed=-1, env_name=None):
    ...
    args.name = f'UR10eEnv-v2_{args.task_name}_{args.goal_type}_{args.reward_mode}_1M'
    ...
    for object_id in [0, 1, 2, 4, 5, 16]:
        ...
        stats['dones'] = dones
        with open(f'{args.work_dir}/eval_ofd_logs_{args.classifier}.txt', 'a') as f:
            f.write(str(stats) + '\n')
