...
python task_rlc_0_ppo.py --env_name=FrankaEnv-v0 --num_envs=4 --group=ppo-sb3-$reward_mode-$mask_type-$condition_type --logdir=$WANDB_DIR --seed=$SLURM_ARRAY_TASK_ID  --reward_mode=$reward_mode --mask_type=$mask_type --condition_type=$condition_type --condition_type=$condition_type
